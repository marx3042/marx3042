...
img1 = cv2.imread('2_final_class\day11_시각정보 다루기\green_back.png')       # 전경 이미지 읽기
img2 = cv2.imread('2_final_class\day11_시각정보 다루기\iceberg.jpg')          # 배경 이미지 읽기
#img2 = cv2.imread('wonju_cctv_install.png')
...
cv2.imshow('green_back.png', img1)
cv2.imshow('iceberg(resized).jpg', back_image )
